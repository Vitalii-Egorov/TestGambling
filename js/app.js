    ...
    (() => {
        ...
        document.addEventListener("DOMContentLoaded", (() => {
            ...
            function documentActions(e) {
                ...
                if (targetEl.classList.contains("actions__lang-EN")) document.querySelector(".header__actions").classList.toggle("_active"); else if (!targetEl.closest(".header__actions")) document.querySelector(".header__actions").classList.remove("_active");
            }
        }));
        window["FLS"] = true;
        isWebp();
